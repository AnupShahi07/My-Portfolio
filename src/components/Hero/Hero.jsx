import myphoto from "../../assets/Anup.png"; // my Image.
import pdf from "../../assets/Anup resume.pdf"; // my resume PDF.
          ...
          <div>
            ...
            <div className="mt-6 flex gap-3">
              <button
                ...
                className="px-3 py-1.5 bg-indigo-600 text-white rounded-md cursor-pointer"
              >
                View Projects
              </button>
              <button
